...
pTypes = ["Muon", "Photon", "Electron", "GenPart"]
...
fNames = ["dxy", "dz", "pt", "pt_tr", "pt_uncor", "m_uncor",  "phi", "eta", "mass", "charge", "phi_tr", "eta_tr",
            "mt", "pfmt", "iso", "eMVA", "eMVA90", "eMVA80", "eMVAL", "tightId", "mediumId", "mediumPromptId", "looseId", "isGlobal", "isTracker",
            "ip3d", "idDTve", "idDTvm", "idDTvj", "idDMNewDMs", "idMVANewDMs", "rawMVANewDMs", "pdgId"]
#longs
...
class outTuple() :
    ...
    def __init__(self,fileName, era, doSyst=False,shift=[], isMC=True, onlyNom=False):
        ...
        self.t.Branch('doubleMuTrig',  self.doubleMuTrig, 'doubleMuTrig/I' )
        ...
        for pType in pTypes:
            exec("self.t.Branch(\'nGood%s\', self.nGood%s, \'nGood%s/I\')"%(pType, pType, pType)) 
    ...
    def Fill(self, entry, goodMuonList, goodPhotonList, goodElectronList, isMC, era, doUncertainties=False, met_pt=-99, met_phi=-99, systIndex=0):
        ...
        if SystIndex ==0 :
            ...
            vnames["eMVA90"] = "mvaFall17V2noIso_WP90"
            vnames["eMVA80"] = "mvaFall17V2noIso_WP80"
            vnames["eMVAL"] = "mvaFall17V2noIso_WPL"
            vnames["eMVA"] = "mvaFall17V2noIso"
           ...
           # print("boutta initiate to -99")
            ...
            for j in range(entry.nSV):
                try:
                    ...
                    print("WARNING: SV out of range; nSV: %d, j: %d"%(entry.nSV, j)) 
                    continue
...
#                        print("i={}, scaleWeight={}".format(i, entry.LHEScaleWeight[i]))
        ...
        for pType in pTypes:
            ...
            if pType == "GenPart":
                if not isMC: 
                    continue
                goodList = [j for j in range(entry.nGenPart)]
            else:
